...
${SelectAccountName_HM}                xpath://a[contains(@title,'Patricia Ferrari')]
...
${AccountName}                      Randall Newton
${AccountName1}                     Patricia Ferrari
${NewClinicalAssessment}            xpath://button[@name='Lead.New_Clinical_Assessment']
...
${clickopenedAccount}               xpath://button[contains(@title,'Close Randall Newton')]
${clickopenedAccount_HM}               xpath://button[contains(@title,'Close Patricia Ferrari')]
*** Keywords ***
...
# Click Link                   ${ClickAccounts}
        ...
        Wait Until Page Contains Element       ${AccountSearch}         30s
         Click Element                         ${AccountSearch1}
         Input Text                            ${AccountSearch1}       ${AccountName1}
         Press Keys                            ${AccountSearch1}        ENTER
         Sleep  4s
#Maximize Browser Window
#Wait Until Page Contains Element  ${SelectAccountName}  18s
        Click Element                          ${SelectAccountName_HM}
...
NewHousehold Pageload
        ...
        #Wait Until Page Contains Element         ${clickopenedAccount}          25s
        Sleep  2s
        Click Element                             ${clickopenedAccount_HM}
